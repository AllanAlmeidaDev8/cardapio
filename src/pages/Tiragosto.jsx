...
const Tiragosto = () => {
    ...
    const tiraGostoItems = [
        { nome: 'Carne do Sol mista ', valor: 50.00, imagem: './assets/download.jpg' },
        { nome: 'Carne do Sol', valor: 45.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Frango a passarinha', valor: 45.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Arrumadinho', valor: 45.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Camarão ao alho e óleo', valor: 46.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Isca de frango com fritas', valor: 44.00, imagem: '/assets/frango-passarinho.jpg' },
    ...
    const tiraGostoChapaItems = [
        ...
        { nome: 'Picanha c/ queijo coalho', valor: 57.00, imagem: '/assets/linguica-chapa.jpg' },
        { nome: 'Picanha acebolada', valor: 57.00, imagem: '/assets/linguica-chapa.jpg' },
        { nome: 'Picanha c/ fritas', valor: 58.00, imagem: '/assets/linguica-chapa.jpg' },
        { nome: 'Cupim acebolado', valor: 47.00, imagem: '/assets/linguica-chapa.jpg' },
        { nome: 'Filé c/ fritas', valor: 52.00, imagem: '/assets/linguica-chapa.jpg' },
        { nome: 'Filé c/ queijo coalho', valor: 52.00, imagem: '/assets/linguica-chapa.jpg' },
    ];

    const petiscosItems = [
        { nome: 'Batata Frita', valor: 22.00, imagem: '/assets/batata-frita.jpg' },
        { nome: 'Batata Sr', valor: 45.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Tabua de frios', valor: 25.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Kit Salgados', valor: 28.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Espetinho de camarão', valor: 12.00, imagem: '/assets/frango-passarinho.jpg' },
        { nome: 'Espetinho carne', valor: 10.00, imagem: '/assets/frango-passarinho.jpg' },
    ...
    const porcoesItems = [
        ...
        { nome: 'Meu feijão Tropeiro', valor: 8.00, imagem: '/assets/polenta.jpg' },
    ];
