...
const Pirao = () => {
    ...
    const piraoItems = [
        { nome: 'Feijão Tropeiro', valor: 25.00, imagem: '/assets/feijao-tropeiro.jpg' },
        { nome: 'Arroz à Grega', valor: 20.00, imagem: '/assets/arroz-grega.jpg' }
    ];
            ...
            <div className="ista_itens">
                {piraoItems.map((item, index) => (
                    <label key={index} htmlFor={`pirao-${index}`} className="item-container">
                        <input type="checkbox" id={`pirao-${index}`} onClick={() => adicionarAoCarrinho(item)} />
